...
void loop() {
  ...
  if (currentTime - lastPrint >= 50) {
    ...
    if (PLOTTER_MODE) {
      ...
      Serial.print("\t");
      Serial.print("Theta_deg/100:");    Serial.print(theta * (180.0 / PI) / 100.0, 4);
      Serial.print("\t");
      Serial.print("X_m:");             Serial.print(x, 4);
      Serial.print("\t");
      Serial.print("Target_x:");        Serial.print(target_x, 4);
      Serial.print("\t");
      Serial.print("Control/1000:");    Serial.println(motorSpeed / 1000.0, 4);
    } else {
